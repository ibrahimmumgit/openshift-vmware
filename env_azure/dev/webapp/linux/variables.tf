...
variable "linux_webapp_count" {
  description = "Number of Linux web Apps to create."
  type        = number
  default     = 1
}
...
variable "sku_size_linux" {
  description = "The size of the SKU for the Linux web App Service Plan."
  type        = string
  default     = "B1"
...
variable "runtime_stack_linux" {
  description = "The runtime stack for the Azure Linux web App (e.g., node, dotnet, java, powershell ,python )"
  type        = string
  default     = null
}

variable "runtime_version_linux" {
  description = "The runtime version for the Azure Linux web App (e.g., 18, 3.9, 6.0, 11)"
  type        = string
  default     = null
}
...
variable "container_name" {
  description = "Name of the existing container name."
  type        = string
  default     = null
